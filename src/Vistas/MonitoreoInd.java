 ...
 */
public class MonitoreoInd extends javax.swing.JFrame {

    /**
     * Creates new form MonitoreoInd
     */
    public MonitoreoInd() {
        initComponents();
        mostrarMonitoreo();
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
         ...
         String p = d.pac;
        try {
            MessageFormat header = new MessageFormat("Monitoreo del paciente "+ p); //encabezado
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MonitoreoInd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MonitoreoInd().setVisible(true);
            }
        });
    }
